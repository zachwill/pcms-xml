...
- [ ] `web/app/views/tools/system_values/` all four table partials: outer row div uses `dark:hover:bg-yellow-900/10` but Salary Book `_player_row.html.erb` L20 uses `dark:hover:bg-yellow-900/25`. Low priority — cosmetic dark mode hover intensity mismatch.
