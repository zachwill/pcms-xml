...
- [ ] Add assertion-style SQL tests in `queries/sql/` for `pcms.fn_luxury_tax_amount` / `pcms.fn_team_luxury_tax` (edge cases + 1–2 parity spot checks vs Sean workbook outputs). → See `reference/warehouse/specs/fn_luxury_tax_amount.md` §10.
