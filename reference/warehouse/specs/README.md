...
- Tiered reading order (fastest path to “think like Sean”): `AGENTS.md`
- Shared formula patterns (high leverage): `patterns.md`
- Worked examples / scenario worksheets: `examples/` (not canonical rules)
- Snapshot stubs of duplicated sheets: `snapshots/`
