...
- [x] **Deleted** `prototypes/salary-book-react/src/features/SalaryBook/hooks/useScrollSpy.ts` (dead; Shell uses the canonical one)
- [x] Canonical hook: `prototypes/salary-book-react/src/features/SalaryBook/shell/useScrollSpy.ts`
...
- [x] Added `prototypes/salary-book-react/src/lib/animate.ts`:
...
- [x] Added `prototypes/salary-book-react/src/features/SalaryBook/shell/useSidebarTransition.ts`:
...
- [x] Added to `prototypes/salary-book-react/src/lib/animate.ts`:
...
- [x] Added `prototypes/salary-book-react/src/features/SalaryBook/components/RightPanel/BackButtonTeamBadge.tsx`:
