# PCMS Salary Book (React prototype)

This directory contains the **Bun + React** Salary Book prototype for this repo (kept as a reference implementation).

Canonical UI going forward lives in `web/` (Rails + Datastar).
