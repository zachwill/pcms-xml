-- 061_salary_book_is_min_contract_exclude_3pls.sql
--
-- Update the minimum-contract flag to exclude 3+ year minimums.
--
-- Existing fields:
-- - min_contract_code (NO / 1OR2 / 3PLS)
-- - min_contract_lookup_value
--
-- is_min_contract is true only for min_contract_code = '1OR2'.
