...
function getRemaining(row: TeamException, year: (typeof SALARY_YEARS)[number]): number | null {
  switch (year) {
    case 2025:
      return row.remaining_2025;
    case 2026:
      return row.remaining_2026;
    case 2027:
      return row.remaining_2027;
    case 2028:
      return row.remaining_2028;
    case 2029:
      return row.remaining_2029;
  }
}
...
export function ExceptionsSection({ exceptions }: { exceptions: TeamException[] }) {
  ...
  return (
    <div>
      <SectionHeader label="Exceptions" count={exceptions.length} />
