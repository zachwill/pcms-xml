  ...
  class AgenciesSseController < AgenciesController
    ...
    def refresh
      ...
      with_sse_stream do |sse|
        main_html = without_view_annotations do
          render_to_string(partial: "entities/agencies/workspace_main")
        end

        sidebar_html = without_view_annotations do
          render_to_string(partial: "entities/agencies/rightpanel_base")
        end
    ...
    def refreshed_overlay_payload(requested_overlay_id:)
      ...
      html = without_view_annotations do
        render_to_string(partial: "entities/agencies/rightpanel_overlay_agency", locals: load_sidebar_agency_payload(requested_overlay_id))
      end
