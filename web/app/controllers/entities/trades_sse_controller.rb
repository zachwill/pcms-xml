  ...
  class TradesSseController < TradesController
    ...
    def refresh
      ...
      with_sse_stream do |sse|
        main_html = without_view_annotations do
          render_to_string(partial: "entities/trades/results")
        end

        sidebar_html = without_view_annotations do
          render_to_string(partial: "entities/trades/rightpanel_base")
        end
    ...
    def refreshed_overlay_payload(requested_type:, requested_id:)
      ...
      html = without_view_annotations do
        render_to_string(partial: "entities/trades/rightpanel_overlay_trade", locals: load_sidebar_trade_payload(requested_id))
      end
