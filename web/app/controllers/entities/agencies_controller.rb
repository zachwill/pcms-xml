module Entities
  class AgenciesController < ApplicationController
    ...
    ACTIVITY_LENSES = %w[all active inactive].freeze
    ...
    def pane
      load_index_workspace_state!
      render partial: "entities/agencies/workspace_main"
    end

    # GET /agencies/sidebar/base
    def sidebar_base
      load_index_workspace_state!
      render partial: "entities/agencies/rightpanel_base"
    end
    ...
    def sidebar_clear
      render partial: "entities/agencies/rightpanel_clear"
    end
    ...
    def sidebar_filter_labels
      ...
      labels << "Activity: #{activity_lens_label(@activity_lens)}" unless @activity_lens == "all"
